...
export default function HomePage() {
  ...
  async function fetchProducts() {
    ...
    try {
      ...
      if (sortBy === "price_asc") data.sort((a, b) => a.min_price - b.min_price);
      else if (sortBy === "price_desc") data.sort((a, b) => b.min_price - a.min_price);
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
                {products.map((product, i) => (
                  ...
                  >
                    ...
                    <div className="p-5">
                      <span className="text-xs font-medium mb-1 block" style={{ color: C.mid }}>
                      ...
                      <p className="text-xs mb-3 line-clamp-2 opacity-70" style={{ color: C.text }}>
                        {product.description}
                      </p>
