...
import { SITE_NAME, DESCRIPTION } from '@/lib/metadata'
    ...
    >
      <div className='max-w-7xl mx-auto px-6 py-10 md:py-12'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-10'>
          ...
          <div>
            <Image src='/logo.webp' alt='logo' width={8 * 8} height={8 * 8} />
            <h3 className='text-xl font-semibold mb-4' style={{ color: C.mid }}>
              {SITE_NAME}
            </h3>
