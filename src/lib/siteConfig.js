...
export const siteConfig = {
  ...
  tagline: "Jamu Tradisional Tanpa Pemanis Buatan. ",
  description: "Jamu tradisional asli dibuat dari empon-empon alami segar, bukan bubuk instan. Menggunakan gula asli tanpa pemanis buatan. Sehat, alami, dan terpercaya.",

  contact: {
    whatsapp: "6288989546234",
    email: "jagadrenata001@gmail.com",
    phone: "+62 889-8954-6234",
    address: {
      street: "",
      detail: "Cibukan, Kel. Sumberadi, Kec. Mlati",
      city: "Yogyakarta",
      postalCode: "55288"
    },
    hours: [
  ...
  maps: {
    ...
    directUrl: "https://maps.google.com/?q=Jamu+Mbak+Mur"
  },

  url: {
    base: "https://jamubumarmur.biz.id",
  ...
  whatsappOrderMessage: (orderId = "") =>
    siteConfig.url.whatsapp(
      `Halo min, saya ingin menanyakan pesanan saya${
...
/**
 * Helper biar gak split manual di UI
 */
export function getCityParts(fullCity = "") {
  if (!fullCity) return { city: "-", postalCode: "" };

  const [city, postalCode] = fullCity.split(",");
  return {
    city: city?.trim() || "-",
...
export const outlets = [
  {
    ...
    description:
      "Outlet pusat kami di Kotagede dengan koleksi jamu lengkap dan fasilitas prima."
  },

  {
    ...
    hours: [{ hari: "Senin – Minggu", jam: "09.00 – 18.00" }],
    ...
    description:
      "Outlet di pusat wisata Malioboro dengan parkir luas dan pelayanan cepat."
  },

  {
    ...
    description:
      "Outlet di kawasan wisata Kota Tua Jakarta dengan suasana tradisional."
  },

  {
    ...
    hours: [{ hari: "Senin – Minggu", jam: "08.00 – 20.00" }],
    ...
    description:
      "Outlet modern di Semanggi dengan fasilitas lengkap dan produk eksklusif."
  }
];